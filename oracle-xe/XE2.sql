...
alter table "INVENTORY_USER"."INVENTORY_STOCK" add constraint INVENTORY_ITEM_ID_FK 
foreign key("INVENTORY_ITEM_ID") references "INVENTORY_USER"."INVENTORY_ITEM"("ID");

CREATE SEQUENCE "INVENTORY_USER"."INVENTORY_STOCK_SEQ"
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;

SELECT "INVENTORY_USER"."INVENTORY_STOCK_SEQ".NEXTVAL FROM DUAL;

CREATE INDEX "INVENTORY_USER"."idx_inventory_name" ON "INVENTORY_USER"."INVENTORY_ITEM" (name);

CREATE INDEX "INVENTORY_USER"."idx_inventory_sku_code" ON "INVENTORY_USER"."INVENTORY_STOCK" (sku_code);
